...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var keyAmmo:Array<Int> = [4, 6, 21, 13];
	...
	function addSongUI():Void
	{
		...
		var m_check2 = new FlxUICheckBox(60, 45, null, null, "21", 100);
		...
		var m_check3 = new FlxUICheckBox(110, 45, null, null, "13", 100);
	...
	var typeNames:Array<String> = ['Normal', 'Tricky', 'HD', 'tiky', 'hell', 'WHY'];
	...
	function addSectionUI():Void
	{
		...
		typeNameTxt = new FlxText(tx, ty + 22, 0, 'Normal notes', 15);
	...
	function addTIKY():Void
	{
		var tab_group_TIKY = new FlxUI(null, UI_box);
		tab_group_TIKY.name = 'TIKY';
	...
	function generateUI():Void
	{
		...
		// general shit
		var title:FlxText = new FlxText(UI_box.x + 22, UI_box.y + 22, 0);
	...
	override function update(elapsed:Float)
	{
		...
		if (_song.mania == 3 && gridBG.width != S_GRID_SIZE * 26)
		{
			remove(gridBG);
			gridBG = FlxGridOverlay.create(S_GRID_SIZE, GRID_SIZE, S_GRID_SIZE * 26, GRID_SIZE * 16);
			add(gridBG);
		}
		if (_song.mania == 2 && gridBG.width != S_GRID_SIZE * 42)
		{
			remove(gridBG);
			gridBG = FlxGridOverlay.create(S_GRID_SIZE, GRID_SIZE, S_GRID_SIZE * 42, GRID_SIZE * 16);
			add(gridBG);
		}
		if (_song.mania == 1 && gridBG.width != GRID_SIZE * 18)
		{
			remove(gridBG);
